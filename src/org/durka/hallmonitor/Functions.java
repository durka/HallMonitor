		...
		public static void enableCoverTouch(Context ctx, Boolean value) {
			...
			if (PreferenceManager.getDefaultSharedPreferences(ctx).getBoolean("pref_runasroot", false)) {
				if(value) {
					...
					if (Build.DEVICE.equals(DEV_SERRANO_LTE_CM10) || Build.DEVICE.equals(DEV_SERRANO_LTE_CM11) || Build.DEVICE.equals(DEV_SERRANO_DS_CM10) || Build.DEVICE.equals(DEV_SERRANO_DS_CM11) || Build.DEVICE.equals(DEV_SERRANO_3G_CM11)) {
