	...
	public boolean onDrag(View v, DragEvent dragevent) {
		...
		case DragEvent.ACTION_DRAG_ENDED:
			if (dropEventNotHandled(dragevent)) {
				dragView.setVisibility(View.VISIBLE);
				Log.d("DragnDrop",
						"Not dropped in target area, restoring default");
			}
			break;
		}
		return true;
