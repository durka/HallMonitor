...
public class Events {
	...
	public class InputDevice {
		...
		public boolean Open(boolean forceOpen, boolean rootAccess) {
			...
			m_bOpen = (res == 0);
			// debug
			Log.d(LT, "Open:" + m_szPath + " Name:" + m_szName + " Version:"
					+ m_nVersion + " Location:" + m_szLocation + " IdStr:"
					+ m_szIdStr + " Result:" + m_bOpen);
			// done, return
			return m_bOpen;
		}
	}
	...
	public int AddDevice(String fullpath) {
		...
		if (n > 0) {
			m_Devs.add(new InputDevice(
					getDevicePath(getDeviceAtPosition(n - 1))));
			return Refresh();
		} else {
			return -1;
		}
	...
	private native static int AddOneDevice(String fullpath); // return number of
																// devs
