...
- You can download [`bin/HallMonitor-debug.apk`](https://github.com/durka/HallMonitor/blob/0.4.0/bin/HallMonitor-debug.apk?raw=true) from one of the tagged versions, and install it on your phone assuming you have sideloading turned on.
